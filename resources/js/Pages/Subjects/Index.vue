                ...
                <div class="bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-slate-200/50">
                    <div class="flex flex-col md:flex-row gap-4 items-center justify-between">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <Link v-if="can('create-subjects')" :href="route('subjects.create')" class="bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-6 py-3 rounded-2xl font-semibold hover:from-indigo-600 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        ...
                        <div v-for="subject in filteredSubjects" :key="subject.id" class="bg-white rounded-3xl shadow-xl border border-slate-200/50 overflow-hidden flex flex-col transition-all duration-300 hover:shadow-2xl hover:scale-105">
                            ...
                            <div class="p-6 flex-1 flex flex-col justify-between">
                                ...
                                <div class="flex items-center justify-between pt-4 border-t border-slate-200/50">
                                    ...
                                    <div class="flex items-center space-x-2" v-if="can('edit-subjects') || can('delete-subjects')">
                                        <Link v-if="can('edit-subjects')" :href="route('subjects.edit', subject.id)" class="p-2 text-amber-600 hover:bg-amber-100 rounded-full transition-colors duration-150">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path>
                                            </svg>
                                        </Link>
                                        <button v-if="can('delete-subjects')" @click="deleteSubject(subject)" class="p-2 text-red-600 hover:bg-red-100 rounded-full transition-colors duration-150">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
